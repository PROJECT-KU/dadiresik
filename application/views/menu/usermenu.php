                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg">
                            ...
                            <a href="" class="btn btn-primary" data-toggle="modal" data-target="#usermenubaru">Tambahkan User Menu Baru</a>
                                    ...
                                    <?php foreach ($MenuUser as $mu) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= base_url() ?>menu/usermenuhapus/<?= $mu['id'] ?>" class="badge badge-danger">Delete</a>
                                            </td>
                                        </tr>
                                        <?php $i++; ?>
                                    <?php endforeach; ?>
